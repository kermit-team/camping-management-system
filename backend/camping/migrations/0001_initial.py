# Generated by Django 4.2 on 2023-04-25 18:21
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payment', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='camping.payment')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('stars', models.IntegerField(choices=[(1, 'Bad'), (2, 'Decent'), (3, 'Ok'), (4, 'Great'), (5, 'Awesome')])),
