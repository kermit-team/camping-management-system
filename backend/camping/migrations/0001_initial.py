# Generated by Django 4.2 on 2023-05-17 20:08
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('method', models.CharField(choices=[('Paypal', 'Paypal'), ('PayU', 'Payu'), ('BLIK', 'Blik'), ('Karta kredytowa', 'Credit Card'), ('Przelew tradycyjny', 'Traditional Transfer')], max_length=25)),
                ('status', models.CharField(choices=[('Oczekiwanie na płatność', 'Waiting For Payment'), ('W trakcie realizacji', 'In Progress'), ('Anulowana', 'Canceled'), ('Zatwierdzona', 'Approved')], default='Oczekiwanie na płatność', max_length=25)),
